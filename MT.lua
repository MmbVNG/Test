...
local H = Library:Tab("Info","12950870585")
local Main = Library:Tab("General","6026568198")
local N = Library:Tab("Necessary","11155986081")
local M = Library:Tab("Item","9606626859")
local RaceV4 = Library:Tab("Race V4","11446900930")
local R = Library:Tab("Dungeon","7044284832")
local P = Library:Tab("Combat","7251993295")
local T = Library:Tab("Teleport","11155851001")
local S = Library:Tab("Shop","6031265976")
local D = Library:Tab("Fruit","7044233235")
