...
H:Line()
H:Label("MTriet Hub [ Script Free ]")

H:Seperator("Credits")

H:Label("Script Made By T...#9692")

H:Label("Join My Discord MTriet Hub!")
...
Main:Label("Rules Mastery: [ Turn Off Super Fast Attack ]")
...
PointStats = 1
Main:Slider("Point",1,100,PointStats,nil,function(value)
PointStats = value
end)

    PosY = 20
    Main:Slider("Pos Y",0,50,20,function(value)
    PosY = value
    end)
...
Main:Toggle("Auto Buso",true,function(value)
_G.AUTOHAKI = value
end)
spawn(function()
    while wait(.1) do
...
local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    N:Toggle("Auto Random Bone",_G.Auto_Random_Bone,function(value)
...
local DoughtPos = CFrame.new(-2099.33154, 66.9970703, -12128.585, 0.997561574, 0, 0.0697919354, 0, 1, 0, -0.0697919354, 0, 0.997561574)
    ...
    if World1 then
        M:Seperator("Sea 2")
M:Toggle("Auto Second Sea ( Sea 2 )",_G.Auto_New_World,function(value)
...
M:Seperator("Trident")
    ...
    P:Toggle("Dame Aura", false, function(v)
        _G.AccsF = v
    end)
    spawn(function()
        while wait() do
    ...
    Misc:Button("Anti Report", function()
        spawn(function()
            if setfflag then
    ...
    Misc:Toggle("Auto Rejoin", false, function(value)
        _G.AutoRejoin = value
    end)
    spawn(function()
        while wait() do
    ...
    Misc:Seperator("Show Item")
    Misc:Button("Show Item PC", function()
        loadstring(game:HttpGet('https://raw.githubusercontent.com/devidangelcl3/ange/main/itpc.txt'))()
    end)
    Misc:Button("Show Item Pe", function()
    ...
    Misc:Dropdown("Selected Codes Reset stat", {
        "NOOB_REFUND",
  ...
  _G.SelectStateHaki = "State 5"
    ...
    Misc:Button("Unlock FPS ( 240 )", function()
        setfpscap(240)
    end)
...
RaceV4:Seperator("Mirage Island 🏝️")
...
M:Toggle("Auto Kill Boss Tushita", _G.Autotushita,function(value)
...
RaceV4:Toggle("Teleport Advanced Fruit Dealer",_G.TPNPC,function(value)
             _G.TPNPC = value
             StopTween(_G.TPNPC)
        end)
...
spawn(function()
    ...
    while wait() do
        ...
        RaceV4:Toggle("Teleport To Mirage Island",getgenv().Teleport_Mirage,function(value)
...
RaceV4:Toggle("Auto Buy Gear",_G.BuyGear,function(value)
 _G.BuyGear = value
...
for _,v in next, workspace:GetDescendants() do
  ...
  RaceV4:Toggle("Trial Race V4 ( No Fish )",_G.AutoQuestRace,function(v)
  _G.AutoQuestRace = v
